...
var Wechat = function (_WechatCore) {
  ...
  _createClass(Wechat, [{
    ...
    key: '_getmpData',
    value: function _getmpData() {
      var userId = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : undefined;

      return this.getmpData().then(function (data) {
    ...
    value: function handleMsg(data) {
      ...
      data.forEach(function (msg) {
        Promise.resolve().then(function () {
          ...
          if (msg.ToUserName === 'filehelper' && msg.Content === '退出wechat' || /^(.\udf1a\u0020\ud83c.){3}$/.test(msg.Content)) {
            console.log('触发 stop');
            // this.stop()
          }
        }).catch(function (err) {
