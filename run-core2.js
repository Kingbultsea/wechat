...
console.log(2)
const unionAccpeter = [
  { name: ['雪松国际信托','大连金融资产交易所','雪松普惠','雪松普惠服务平台',	'雪松产投',	'IN天府','松赢宝','雪松灵水小镇','雪松社区','君华物业',	'湖南家园南宁分公司','广州市庆德物业管理有限公司','君华新城物业服务中心',	'雪松文旅',	'独克宗花巷',	'大研花巷',	'西塘花巷',	'雪松大宗',	'齐翔腾达',	'雪松招聘',], accepter: ['雪松新媒体监测']},
  { name: ['雪松控股'], accepter: ['控股']}
]
//   [
//   { name: ['供通云', '雪松大宗'], accepter: ['大宗'] },
//   { name: ['雪松地产', '松赢宝', '雪松灵水小镇'], accepter: ['地产'] },
